...
BEGIN_MESSAGE_MAP(CLineDrawingApp, CWinAppEx)
...
CLineDrawingApp::CLineDrawingApp() noexcept
{
	...
	SetAppID(_T("LineDrawing.AppID.NoVersion"));
...
BOOL CLineDrawingApp::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(IDR_LineDrawingTYPE,
